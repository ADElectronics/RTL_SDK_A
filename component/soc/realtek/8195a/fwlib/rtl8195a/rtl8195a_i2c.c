...
HalI2CSendRtl8195a_Patch(
    ...
    uint8_t  I2CIdx  = pHalI2CInitData->I2CIdx;
    uint8_t  *pDat   = pHalI2CInitData->I2CRWData;
    uint8_t  I2CCmd  = pHalI2CInitData->I2CCmd;
    uint8_t  I2CStop = pHalI2CInitData->I2CStop;
    uint8_t  I2CReSTR= pHalI2CInitData->I2CReSTR;
...
HalI2CMassSendRtl8195a_Patch(
    ...
    uint8_t  I2CIdx      = pHalI2CInitData->I2CIdx;
    uint8_t  I2CCmd      = pHalI2CInitData->I2CCmd;
    uint8_t  I2CDatLen   = pHalI2CInitData->I2CDataLen;
    uint8_t  *pDat       = pHalI2CInitData->I2CRWData;
    uint8_t  I2CStopSet  = pHalI2CInitData->I2CStop;
    uint8_t  I2CSTP;
    uint8_t  I2CReSRT = 0;
    uint8_t  DatCnt = 0;
...
{
    PHAL_I2C_INIT_DAT pHalI2CInitData = (PHAL_I2C_INIT_DAT)Data;
    uint8_t  SpdMd = pHalI2CInitData->I2CSpdMod;
    uint32_t I2CClk = pHalI2CInitData->I2CClk;
    uint8_t  I2CIdx = pHalI2CInitData->I2CIdx;
    uint32_t ICHLcnt;
    uint32_t ICHtime;
    uint32_t ICLtime;
...
#ifdef CONFIG_FPGA
    uint32_t IcClk = SYSTEM_CLK/1000000;
#else
    uint32_t IcClk;
    uint32_t ClkSELTmp = 0;
    uint32_t CpuClkTmp = 0;
...
HalI2CEnableRtl8195a_Patch(
    ...
    PHAL_I2C_INIT_DAT pHalI2CInitData = (PHAL_I2C_INIT_DAT)Data;
    uint8_t  I2CIdx  = pHalI2CInitData->I2CIdx;
    uint8_t  I2CICEn = pHalI2CInitData->I2CEn;
    uint32_t I2CTimeoutCount;
    uint32_t I2CStartCount;
    /* Enable I2C module */
