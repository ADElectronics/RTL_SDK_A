...
typedef struct _TX_INFO_ {
    union {
        struct {
            ...
            uint32_t crc:1;          //23
            uint32_t vsel:1;         //22
            uint32_t dislrn:1;       //21
            uint32_t cputag_ipcs:1;  //20
            uint32_t cputag_l4cs:1;  //19
            uint32_t cputag_psel:1;  //18
            uint32_t rsvd:1;         //17
            uint32_t data_length:17; //0~16
        } bit;
        uint32_t dw; //double word
    } opts1;
    ...
    union {
        struct {
            uint32_t cputag:1;          //31
            uint32_t aspri:1;           //30
            uint32_t cputag_pri:3;      //27~29
            uint32_t tx_vlan_action:2;  //25~26
            uint32_t tx_pppoe_action:2; //23~24
            uint32_t tx_pppoe_idx:3;    //20~22
            uint32_t efid:1;            //19
            uint32_t enhance_fid:3;     //16~18
            uint32_t vidl:8;            // 8~15
            uint32_t prio:3;            // 5~7
            uint32_t cfi:1;             // 4
            uint32_t vidh:4;            // 0~3
        } bit;
    ...
    union {
        struct {
            uint32_t extspa:3;           //29~31
            uint32_t tx_portmask:6;      //23~28
            uint32_t tx_dst_stream_id:7; //16~22
            uint32_t rsvd:14;            // 2~15
            uint32_t l34keep:1;          // 1
            uint32_t ptp:1;              // 0
        } bit;
        uint32_t dw; //double word
    } opts3;
    ...
    union {
        struct {
            uint32_t lgsen:1;  //31
            uint32_t lgmss:11; //20~30
            uint32_t rsvd:20;  // 0~19
        } bit;
        uint32_t dw; //double word
    } opts4;
...
typedef struct _RX_INFO_ {
    union{
        struct{
            ...
            uint32_t fs:1;           //29
            uint32_t ls:1;           //28
            uint32_t crcerr:1;       //27
            uint32_t ipv4csf:1;      //26
            uint32_t l4csf:1;        //25
            uint32_t rcdf:1;         //24
            uint32_t ipfrag:1;       //23
            uint32_t pppoetag:1;     //22
            uint32_t rwt:1;          //21
            uint32_t pkttype:4;      //20-17
            uint32_t l3routing:1;    //16
            uint32_t origformat:1;   //15
            uint32_t pctrl:1;        //14
#ifdef CONFIG_RG_JUMBO_FRAME
            uint32_t data_length:14; //13~0
#else
            uint32_t rsvd:2;         //13~12
            uint32_t data_length:12; //11~0
#endif
        }bit;
        uint32_t dw; //double word
    }opts1;
    ...
    union{
        struct{
            uint32_t cputag:1;               //31
            uint32_t ptp_in_cpu_tag_exist:1; //30
            uint32_t svlan_tag_exist:1;      //29
            uint32_t rsvd_2:2;               //27~28
            uint32_t pon_stream_id:7;        //20~26
            uint32_t rsvd_1:3;               //17~19
            uint32_t ctagva:1;               //16
            uint32_t cvlan_tag:16;           //15~0
        }bit;
        uint32_t dw; //double word
    }opts2;
    ...
    union{
        struct{
            uint32_t src_port_num:5;      //27~31
            uint32_t dst_port_mask:6;     //21~26
            uint32_t reason:8;            //13~20
            uint32_t internal_priority:3; //10~12
            uint32_t ext_port_ttl_1:5;    //5~9
            uint32_t rsvd:5;              //4~0
        }bit;
        uint32_t dw; //double word
    }opts3;
