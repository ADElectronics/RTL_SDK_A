...
typedef struct _PCM_CTL_REG_ {
    uint32_t                    FCNT           :8; // Bit 0-7
    uint32_t                    SlaveMode      :1; // Bit 8
    uint32_t                    FsInv          :1; // Bit 9 
    uint32_t                    Rsvd10to11     :1; // Bit 10-11
    uint32_t                    Pcm_En         :1; // Bit 12
    uint32_t                    LinearMode     :1; // Bit 13
    uint32_t                    LoopBack       :1; // Bit 14
    uint32_t                    Rsvd15to16     :2; // Bit 15-16
    uint32_t                    EndianSwap     :1; // Bit 17
    uint32_t                    Rsvd18to31    :14; // Bit 18-31
} PCM_CTL_REG, *PPCM_CTL_REG;



typedef struct _PCM_CHCNR03_REG_ {
    uint32_t                      CH3RE     :1; // Bit 0
    uint32_t                      CH3TE     :1; // Bit 1
    uint32_t                      CH3MuA    :1; // Bit 2
    uint32_t                      CH3Band   :1; // Bit 3
    uint32_t                      CH3SlicSel:4; // Bit 4-7
    uint32_t                      CH2RE     :1; // Bit 8
    uint32_t                      CH2TE     :1; // Bit 9
    uint32_t                      CH2MuA    :1; // Bit 10
    uint32_t                      CH2Band   :1; // Bit 11
    uint32_t                      CH2SlicSel:4; // Bit 12-15
    uint32_t                      CH1RE     :1; // Bit 16
    uint32_t                      CH1TE     :1; // Bit 17
    uint32_t                      CH1MuA    :1; // Bit 18
    uint32_t                      CH1Band   :1; // Bit 19
    uint32_t                      CH1SlicSel:4; // Bit 20-23
    uint32_t                      CH0RE     :1; // Bit 24
    uint32_t                      CH0TE     :1; // Bit 25
    uint32_t                      CH0MuA    :1; // Bit 26
    uint32_t                      CH0Band   :1; // Bit 27
    uint32_t                      CH0SlicSel:4; // Bit 28-31
}PCM_CHCNR03_REG, *PPCM_CHCNR03_REG;

typedef struct _PCM_TSR03_REG_ {
    uint32_t                      CH3TSA    :5; // Bit 0-4
    uint32_t                      Rsvd5to7  :3; // Bit 5-7
    uint32_t                      CH2TSA    :5; // Bit 8-12
    uint32_t                      Rsvd13to15:3; // Bit 13-15
    uint32_t                      CH1TSA    :5; // Bit 16-20
    uint32_t                      Rsvd21to23:3; // Bit 21-23
    uint32_t                      CH0TSA    :5; // Bit 24-28
    uint32_t                      Rsvd29to31:3; // Bit 29-31
}PCM_TSR03_REG, *PPCM_TSR03_REG;

typedef struct _PCM_BSIZE03_REG_ {
    uint32_t                      CH3BSize  :8; // Bit 0-7
    uint32_t                      CH2BSize  :8; // Bit 8-15
    uint32_t                      CH1BSize  :8; // Bit 16-23
    uint32_t                      CH0BSize  :8; // Bit 24-31
}PCM_BSIZE03_REG, *PPCM_BSIZE03_REG;

typedef struct _PCM_ISR03_REG_ {
    uint32_t                      CH3RXP1UA :1; // Bit 0
    uint32_t                      CH3RXP0UA :1; // Bit 1
    uint32_t                      CH3TXP1UA :1; // Bit 2
    uint32_t                      CH3TXP0UA :1; // Bit 3
    uint32_t                      CH3RXP1IP :1; // Bit 4
    uint32_t                      CH3RXP0IP :1; // Bit 5
    uint32_t                      CH3TXP1IP :1; // Bit 6
    uint32_t                      CH3TXP0IP :1; // Bit 7
    uint32_t                      CH2RXP1UA :1; // Bit 8
    uint32_t                      CH2RXP0UA :1; // Bit 9
    uint32_t                      CH2TXP1UA :1; // Bit 10
    uint32_t                      CH2TXP0UA :1; // Bit 11
    uint32_t                      CH2RXP1IP :1; // Bit 12
    uint32_t                      CH2RXP0IP :1; // Bit 13
    uint32_t                      CH2TXP1IP :1; // Bit 14
    uint32_t                      CH2TXP0IP :1; // Bit 15
    uint32_t                      CH1RXP1UA :1; // Bit 16
    uint32_t                      CH1RXP0UA :1; // Bit 17
    uint32_t                      CH1TXP1UA :1; // Bit 18
    uint32_t                      CH1TXP0UA :1; // Bit 19
    uint32_t                      CH1RXP1IP :1; // Bit 20
    uint32_t                      CH1RXP0IP :1; // Bit 21
    uint32_t                      CH1TXP1IP :1; // Bit 22
    uint32_t                      CH1TXP0IP :1; // Bit 23
    uint32_t                      CH0RXP1UA :1; // Bit 24
    uint32_t                      CH0RXP0UA :1; // Bit 25
    uint32_t                      CH0TXP1UA :1; // Bit 26
    uint32_t                      CH0TXP0UA :1; // Bit 27
    uint32_t                      CH0RXP1IP :1; // Bit 28
    uint32_t                      CH0RXP0IP :1; // Bit 29
    uint32_t                      CH0TXP1IP :1; // Bit 30
    uint32_t                      CH0TXP0IP :1; // Bit 31
