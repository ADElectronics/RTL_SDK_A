...
_LONG_CALL_ROM_ void HalI2CWrite32(IN uint8_t I2CIdx, IN uint8_t I2CReg, IN uint32_t I2CVal);
_LONG_CALL_ROM_ uint32_t HalI2CRead32(IN uint8_t I2CIdx, IN uint8_t I2CReg);
...
_LONG_CALL_ uint8_t HalI2CReceiveRtl8195a(IN void *Data);
...
_LONG_CALL_ uint32_t HalI2CReadRegRtl8195a(IN void *Data, IN uint8_t I2CReg);
_LONG_CALL_ HAL_Status HalI2CWriteRegRtl8195a(IN void *Data, IN uint8_t I2CReg, IN uint32_t RegVal);
