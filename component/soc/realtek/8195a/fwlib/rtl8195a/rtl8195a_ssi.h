...
_LONG_CALL_ HAL_Status HalSsiWriteRtl8195a(void *Adaptor, uint32_t value);
...
_LONG_CALL_ HAL_Status HalSsiSetDeviceRoleRtl8195a(void *Adaptor, uint32_t Role);
...
_LONG_CALL_ HAL_Status HalSsiReadInterruptRtl8195a(void *Adaptor, void *RxData, uint32_t Length);
...
_LONG_CALL_ HAL_Status HalSsiWriteInterruptRtl8195a(void *Adaptor, void *TxData, uint32_t Length);
_LONG_CALL_ROM_ HAL_Status HalSsiSetSlaveEnableRegisterRtl8195a(void *Adaptor, uint32_t SlaveIndex);
_LONG_CALL_ROM_ uint32_t HalSsiBusyRtl8195a(void *Adaptor);
_LONG_CALL_ROM_ uint32_t HalSsiWriteableRtl8195a(void *Adaptor);
_LONG_CALL_ROM_ uint32_t HalSsiReadableRtl8195a(void *Adaptor);
_LONG_CALL_ROM_ uint32_t HalSsiGetInterruptMaskRtl8195a(void *Adaptor);
_LONG_CALL_ROM_ uint32_t HalSsiGetRxFifoLevelRtl8195a(void *Adaptor);
_LONG_CALL_ uint32_t HalSsiGetTxFifoLevelRtl8195a(void *Adaptor);
_LONG_CALL_ROM_ uint32_t HalSsiGetStatusRtl8195a(void *Adaptor);
_LONG_CALL_ROM_ uint32_t HalSsiGetInterruptStatusRtl8195a(void *Adaptor);
_LONG_CALL_ uint32_t HalSsiReadRtl8195a(void *Adaptor);
_LONG_CALL_ uint32_t HalSsiGetRawInterruptStatusRtl8195a(void *Adaptor);
_LONG_CALL_ROM_ uint32_t HalSsiGetSlaveEnableRegisterRtl8195a(void *Adaptor);

_LONG_CALL_ROM_ void _SsiReadInterrupt(void *Adaptor);
_LONG_CALL_ROM_ void _SsiWriteInterrupt(void *Adaptor);
_LONG_CALL_ uint32_t  _SsiIrqHandle(void *Adaptor);
...
HAL_Status HalSsiIntWriteRtl8195a(void *Adapter, uint8_t *pTxData, uint32_t Length);
...
HAL_Status HalSsiIsTimeoutRtl8195a(uint32_t StartCount, uint32_t TimeoutCnt);
...
HAL_Status HalSsiIntReadRtl8195a_V04(void *Adapter, void *RxData, uint32_t Length);
HAL_Status HalSsiIntWriteRtl8195a_V04(void *Adapter, uint8_t *pTxData, uint32_t Length);
HAL_Status HalSsiClockOffRtl8195a_V04(void * Adapter);
HAL_Status HalSsiClockOnRtl8195a_V04(void * Adapter);
void HalSsiSetSclkRtl8195a_V04(void *Adapter, uint32_t ClkRate);
...
HAL_Status HalSsiDmaSendRtl8195a_V04(IN void * Adapter, IN uint8_t * pTxData, IN uint32_t Length);
HAL_Status HalSsiDmaRecvRtl8195a_V04(IN void * Adapter, IN uint8_t * pRxData, IN uint32_t Length);
HAL_Status HalSsiDmaSendMultiBlockRtl8195a_V04(void * Adapter, uint8_t * pTxData, uint32_t Length);
HAL_Status HalSsiDmaRecvMultiBlockRtl8195a_V04(void * Adapter, uint8_t * pRxData, uint32_t Length);
...
HAL_Status HalSsiDmaSendRtl8195a(void *Adapter, uint8_t *pTxData, uint32_t Length);
HAL_Status HalSsiDmaRecvRtl8195a(void *Adapter, uint8_t *pRxData, uint32_t Length);
HAL_Status HalSsiDmaSendMultiBlockRtl8195a(void * Adapter, uint8_t * pRxData, uint32_t Length);
HAL_Status HalSsiDmaRecvMultiBlockRtl8195a(void * Adapter, uint8_t * pRxData, uint32_t Length);
