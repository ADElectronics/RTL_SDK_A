...
extern int rtl_lib_test(IN uint16_t argc, IN uint8_t *argv[]);
extern int rtl_math_test(IN uint16_t argc, IN uint8_t *argv[]);
extern int rtl_string_test(IN uint16_t argc, IN uint8_t *argv[]);
