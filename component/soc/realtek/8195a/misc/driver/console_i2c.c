...
const uint8_t DLL = 921600/UART_BAUDRATE;
...
static uint8_t    tx_data_i2c[2];
static uint8_t    rx_data_i2c[2];

void i2c_put_char(uint8_t c){
...
void HalSerialPutcRtl8195a(IN  uint8_t c){
