 ...
 ******************************************************************************/
static PRTL_MAILBOX RtlMBoxIdToHdl(IN uint8_t MBoxId);

PRTL_MAILBOX RtlMailboxCreate(IN uint8_t MboxID, IN uint32_t MboxSize, IN _Sema *pWakeSema);

void RtlMailboxDel(IN PRTL_MAILBOX MboxHdl);

uint8_t RtlMailboxSendToBack(
    IN uint8_t MboxID, 
    IN MSG_BLK *pMsg, 
