...
int i2c_read(i2c_t *obj, int address, uint8_t *data, int length, int stop) 
{
    PSAL_I2C_MNGT_ADPT      pSalI2CMngtAdpt     = NULL;
    PSAL_I2C_HND            pSalI2CHND          = NULL;
    ...
    pSalI2CHND->pRXBuf->pDataBuf  = (uint8_t *)data;
...
int i2c_write(i2c_t *obj, int address, const uint8_t *data, int length, int stop) 
{
    PSAL_I2C_MNGT_ADPT      pSalI2CMngtAdpt     = NULL;
    PSAL_I2C_HND            pSalI2CHND          = NULL;
    uint32_t I2CInTOTcnt     = 0;
    ...
    pSalI2CHND->pTXBuf->pDataBuf  = (uint8_t *)data;
