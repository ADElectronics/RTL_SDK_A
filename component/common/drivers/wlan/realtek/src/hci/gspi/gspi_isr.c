...
extern struct recv_buf* rtw_recv_rxfifo(_adapter * padapter, uint32_t size, struct fifo_more_data* more_data);
...
void spi_int_dpc(PADAPTER padapter, uint32_t sdio_hisr)
{
