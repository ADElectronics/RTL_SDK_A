...
extern int32_t gspi_dvobj_xmit_mgnt(_adapter * padapter, struct xmit_frame *pmgntframe);
extern int32_t gspi_dvobj_xmit_data(_adapter *padapter, struct xmit_frame *pxmitframe);
#endif
...
#define hci_intf_start	rtw_hal_enable_interrupt
#define hci_intf_stop	rtw_hal_disable_interrupt
extern int32_t sdio_dvobj_xmit_mgnt(_adapter * padapter, struct xmit_frame *pmgntframe);
extern int32_t sdio_dvobj_xmit_data(_adapter *padapter, struct xmit_frame *pxmitframe);
