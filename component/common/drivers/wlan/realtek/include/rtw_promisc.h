...
//void promisc_set_enable(_adapter *padapter, uint8_t enabled, uint8_t len_used);
...
void promisc_get_ap_info(rtw_result_t (*func)(char *ssid, uint8_t ssid_len, int16_t rssi, char channel, char security));
