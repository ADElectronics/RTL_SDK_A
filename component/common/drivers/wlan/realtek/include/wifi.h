...
#define HT_INFO_STBC_PARAM_DUAL_BEACON			((uint16_t) BIT(6))
#define HT_INFO_STBC_PARAM_DUAL_STBC_PROTECT		((uint16_t) BIT(7))
#define HT_INFO_STBC_PARAM_SECONDARY_BCN		((uint16_t) BIT(8))
#define HT_INFO_STBC_PARAM_LSIG_TXOP_PROTECT_ALLOWED	((uint16_t) BIT(9))
#define HT_INFO_STBC_PARAM_PCO_ACTIVE			((uint16_t) BIT(10))
#define HT_INFO_STBC_PARAM_PCO_PHASE			((uint16_t) BIT(11))
