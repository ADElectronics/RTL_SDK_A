...
int rtw_generate_bcn_ie(_adapter *adapter, uint8_t *ssid, uint16_t ssid_len, uint8_t *ie);
...
uint8_t ap_free_sta(_adapter *padapter, struct sta_info *psta, uint16_t reason);
