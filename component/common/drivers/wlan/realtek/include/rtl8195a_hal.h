...
typedef struct _RT_FIRMWARE {
	...
	uint8_t*			szFwBuffer;
#else
	uint8_t			szFwBuffer[FW_8723B_SIZE];
#endif
	uint32_t			ulFwLength;
...
#else
	uint8_t			szBTFwBuffer[FW_8723B_SIZE];
#endif
...
// rtl8723a_hal_init.c
int32_t rtl8195a_FirmwareDownload(PADAPTER padapter, BOOLEAN  bUsedWoWLANFw);
...
int32_t rtl8195a_InitLLTTable(PADAPTER padapter);

int32_t CardDisableHWSM(PADAPTER padapter, uint8_t resetMCU);
int32_t CardDisableWithoutHWSM(PADAPTER padapter);

// EFuse
//uint8_t GetEEPROMSize8195a(PADAPTER padapter);
void Hal_InitPGData(PADAPTER padapter, uint8_t *PROMContent);
void Hal_EfuseParseIDCode(PADAPTER padapter, uint8_t *hwinfo);
void Hal_EfuseParseTxPowerInfo_8195A(PADAPTER padapter, uint8_t *PROMContent, BOOLEAN AutoLoadFail);
void Hal_EfuseParseBTCoexistInfo_8195A(PADAPTER padapter, uint8_t *hwinfo, BOOLEAN AutoLoadFail);
void Hal_EfuseParseEEPROMVer_8195A(PADAPTER padapter, uint8_t *hwinfo, BOOLEAN AutoLoadFail);
void Hal_EfuseParseChnlPlan_8195A(PADAPTER padapter, uint8_t *hwinfo, BOOLEAN AutoLoadFail);
void Hal_EfuseParseCustomerID_8195A(PADAPTER padapter, uint8_t *hwinfo, BOOLEAN AutoLoadFail);
void Hal_EfuseParseAntennaDiversity_8195A(PADAPTER padapter, uint8_t *hwinfo, BOOLEAN AutoLoadFail);
void Hal_EfuseParseXtal_8195A(PADAPTER pAdapter, uint8_t *hwinfo, uint8_t AutoLoadFail);
void Hal_EfuseParseThermalMeter_8195A(PADAPTER padapter, uint8_t *hwinfo, uint8_t AutoLoadFail);
...
void SetHwReg8195A(PADAPTER padapter, uint8_t variable, uint8_t *val);
void GetHwReg8195A(PADAPTER padapter, uint8_t variable, uint8_t *val);
uint8_t SetHalDefVar8195A(PADAPTER padapter, HAL_DEF_VARIABLE variable, void *pval);
uint8_t GetHalDefVar8195A(PADAPTER padapter, HAL_DEF_VARIABLE variable, void *pval);
...
void rtl8195a_InitBeaconMaxError(PADAPTER padapter, uint8_t InfraMode);
