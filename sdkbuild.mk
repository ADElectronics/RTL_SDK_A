...
SRC_O = $(patsubst %.c,%.o,$(patsubst sdk/%,%,$(ADD_SRC_C))) $(patsubst %.c,%.o,$(patsubst sdk/%,%,$(SRC_C)))
DRAM_O = $(patsubst %.c,%.o,$(patsubst sdk/%,%,$(DRAM_C)))
BOOT_O = $(patsubst %.c,%.o,$(patsubst sdk/%,%,$(BOOT_C)))

SRC_C_LIST = $(patsubst sdk/%,%,$(ADD_SRC_C)) $(patsubst sdk/%,%,$(SRC_C)) $(patsubst sdk/%,%,$(DRAM_C)) $(patsubst sdk/%,%,$(BOOT_C))
